...
public enum CoreSystem {
	...
	CERTIFICATE_AUTHORITY(8458, 8459, null, null, null, 62542), CHOREOGRAPHER(8456, 8457, null, null, null, 62543),
	...
	GATEKEEPER_INTERNAL(8446, 8447, ArrowheadMain.dbFields,
			Arrays.asList("gatekeeper_keystore", "gatekeeper_keystore_pass", "gatekeeper_keypass", "cloud_keystore",
					"cloud_keystore_pass", "cloud_keypass", "master_arrowhead_cert"),
			null, 62545),
	GATEKEEPER_EXTERNAL(8448, 8449, ArrowheadMain.dbFields,
			Arrays.asList("gatekeeper_keystore", "gatekeeper_keystore_pass", "gatekeeper_keypass", "cloud_keystore",
					"cloud_keystore_pass", "cloud_keypass", "master_arrowhead_cert"),
			Arrays.asList(CoreSystemService.GSD_SERVICE, CoreSystemService.ICN_SERVICE), 62546),
	GATEWAY(8452, 8453, null,
			Arrays.asList("keystore", "keystorepass", "keypass", "truststore", "truststorepass", "trustpass",
					"master_arrowhead_cert"),
			Arrays.asList(CoreSystemService.GW_PROVIDER_SERVICE, CoreSystemService.GW_CONSUMER_SERVICE,
					CoreSystemService.GW_SESSION_MGMT), 62547),
	ORCHESTRATOR(8440, 8441, ArrowheadMain.dbFields, ArrowheadMain.certFields,
			Collections.singletonList(CoreSystemService.ORCH_SERVICE), 62548),
	QOS(8450, 8451, Arrays.asList("db_user", "db_password", "db_address", "monitor_url"), ArrowheadMain.certFields,
			null, 62548),
	SERVICE_REGISTRY_DNS(8442, 8443, null, ArrowheadMain.certFields, null, 62549),
	SERVICE_REGISTRY_SQL(8442, 8443, ArrowheadMain.dbFields, ArrowheadMain.certFields, null, 62550),
	SYSTEM_REGISTRY(8436, 8437, ArrowheadMain.dbFields, ArrowheadMain.certFields,
			Collections.singletonList(CoreSystemService.SYS_REG_SERVICE), 62551),
	DEVICE_REGISTRY(8438, 8439, ArrowheadMain.dbFields, ArrowheadMain.certFields,
			Collections.singletonList(CoreSystemService.DEVICE_REG_SERVICE), 62552);
