...
//        return MoreObjects.toStringHelper(this).add("foo", foo).add("bar", bar).add("baz", baz).toString();
//    }
//
...
//
//        @Override
//        public CustomDataType decode(SerializationContext context, UaDecoder decoder) throws UaSerializationException {
//
...
//
//        @Override
//        public void encode(SerializationContext context, UaEncoder encoder, CustomDataType value)
