...
public class ArrowheadOpcUaServer {
    ...
    public ArrowheadOpcUaServer() throws Exception {
        ...
        OpcUaServerConfig serverConfig = OpcUaServerConfig.builder()
            ...
            .setApplicationName(LocalizedText.english("arrowhead OPC UA Server"))
            .setBindPort(12686)
        ...
        server.getNamespaceManager().registerAndAdd(
            ArrowheadOpcUaNamespace.NAMESPACE_URI,
            idx -> new ArrowheadOpcUaNamespace(server, idx));
    }
    ...
    protected OpcUaServer getOpcUaServer() {
        return server;
    }
