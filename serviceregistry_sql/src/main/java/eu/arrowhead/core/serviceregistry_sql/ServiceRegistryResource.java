...
public class ServiceRegistryResource {
    ...
    public Response registerGeneric(ServiceRegistryEntry entry) {
        ...
        if (savedEntry == null) {
            ...
            throw new DuplicateEntryException("There is already a Service Registry entry with this provider("
                    + provider.getSystemName() + ") and " + "providedService(" + service.getServiceDefinition() + ")");
        }
