...
public class RemoveMethod extends AbstractMethodInvocationHandler {
    public RemoveMethod(UaMethodNode node) {
        super(node);
    }

    private static final Logger log = LoggerFactory.getLogger(RemoveMethod.class.getName());
